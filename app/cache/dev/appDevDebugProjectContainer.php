...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c_1' => 'get409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c1Service',
            '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_1' => 'get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d1Service',
            '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_2' => 'get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d2Service',
            '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_3' => 'get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d3Service',
    ...
    /**
     * Gets the '409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c_1' service.
     *
     ...
     */
    protected function get409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c1Service()
    {
        return $this->services['409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d1Service()
    {
        return $this->services['58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d2Service()
    {
        return $this->services['58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d3Service()
    {
        return $this->services['58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('409a20a5326394a4804ed52b264ef6f6080c8b1b4a5c02c41b72ae02bf20478c_1'), $this->get('data_collector.form'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_1'), 1 => $this->get('58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_2'), 2 => $this->get('58a1e4e9827680eea165e6755361fe6c8a160c68400d5541d9d29d2d746a698d_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/lampp/htdocs/Symfony/src/MyApp/MySiteBundle/Resources/views', 'MySite');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MySiteBundle' => 'MyApp\\MySiteBundle\\MySiteBundle',
